...
## Corpus Check
- 130 files · ~147,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 892 nodes · 1309 edges · 76 communities detected
...
- Included files: 130 · Candidates: 402
- Excluded: 8 untracked · 23908 ignored · 2 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `152d079`
...
Cohesion: 0.06
Nodes (33): AdminVisitFilter, BlackoutOut, BlackoutReq, CreateVisitReq, ForceCancelReq, IncomingVisitOut, MessageOut, MyVisitsOut (+25 more)
...
Cohesion: 0.24
Nodes (3): accept_adjustment(), notify_adjustment_result(), reject_adjustment()
