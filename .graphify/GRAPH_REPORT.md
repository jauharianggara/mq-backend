...
- Included files: 133 · Candidates: 448
- Excluded: 6 untracked · 23916 ignored · 2 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `10592fe`
...
- **Thin community `Community 76`** (2 nodes): `MaterialOut`, `PutProgressReq`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `Q`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (2 nodes): `AppError`, `error_shape_konsisten()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
